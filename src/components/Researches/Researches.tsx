import { Badge, Text, Flex, Heading, Icon, Box, Divider } from '@chakra-ui/core';
...
export const Researches: React.FC = () => {
  return (
    <>
      <Flex id="researches" direction="column" marginBottom={2} width="100%" display={['flex', 'flex', 'flex']}>
        <Heading display="flex" justifyContent="center" marginBottom={3}>
          研究テーマ
        </Heading>

        <Flex wrap="wrap" justify="center" width="inherit">
      ...
      <Divider width="100%" marginBottom={3} />
    </>
  );
};
